	...
	<div id="content">
		<table>
				...
				?>			
					...
					<tr>
						<th nowrap="nowrap">股票</th><?php echo '<td nowrap="nowrap">'.$data[$i]['company_name']."</td>"; ?>
					</tr>
					<tr>
						<th class="css_th2" nowrap="nowrap">帳號</th><?php echo '<td class="css_td2" nowrap="nowrap">'.$data[$i]['帳號']."</td>"; ?>
					</tr>
					<tr>
						<th nowrap="nowrap">EMAIL</th><?php echo '<td nowrap="nowrap">'.$data[$i]['EMAIL']."</td>"; ?>
					</tr>
					<tr>
						<th class="css_th2" nowrap="nowrap">地址</th><?php echo '<td class="css_td2" nowrap="nowrap">'.$data[$i]['地址']."</td>"; ?>
					</tr>
					<tr>
						<th>備註</th><?php echo '<td class="css_notes">'.$data[$i]['備註']."</td>"; ?>
					</tr>
